...
Local RAG pipeline with dual embedding models and LLM inference. Scripts come in two backend variants: **vLLM** (safetensors, GPU half/bfloat16 inference) OR **llama-cpp-python** (GGUF format).
